...
class Adminipy:
    ...
    def getAdmins(self):
        ...
        df_call, df_members, df_ql, df_org = Load.LoadDataFrames(self, self.call_path, self.member_data_path, self.qualifier_path, self.org_path)

        # Identify clubs that need administrators, and potential administrators for these
        current_batch = Identify('Pulje 3')
